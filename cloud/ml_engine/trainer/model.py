...
INPUT_COLUMNS = [
    ...
    tf.feature_column.numeric_column('time'),
    tf.feature_column.numeric_column('v1'),
    tf.feature_column.numeric_column('v2'),
    tf.feature_column.numeric_column('v3'),
    tf.feature_column.numeric_column('v4'),
    tf.feature_column.numeric_column('v5'),    
    tf.feature_column.numeric_column('v6'),
    tf.feature_column.numeric_column('v7'),
    tf.feature_column.numeric_column('v8'),
    tf.feature_column.numeric_column('v9'),
    tf.feature_column.numeric_column('v10'),
    tf.feature_column.numeric_column('v11'),
    tf.feature_column.numeric_column('v12'),
    tf.feature_column.numeric_column('v13'),
    tf.feature_column.numeric_column('v14'),
    tf.feature_column.numeric_column('v15'),    
    tf.feature_column.numeric_column('v16'),
    tf.feature_column.numeric_column('v17'),
    tf.feature_column.numeric_column('v18'),
    tf.feature_column.numeric_column('v19'),
    tf.feature_column.numeric_column('v20'),
    tf.feature_column.numeric_column('v21'),
    tf.feature_column.numeric_column('v22'),
    tf.feature_column.numeric_column('v23'),
    tf.feature_column.numeric_column('v24'),
    tf.feature_column.numeric_column('v25'),    
    tf.feature_column.numeric_column('v26'),
    tf.feature_column.numeric_column('v27'),
    tf.feature_column.numeric_column('v28'),
